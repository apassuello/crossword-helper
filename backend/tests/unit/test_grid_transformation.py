...
class TestGridTransformationLogic:
    ...
    def test_all_transformation_cases(self, test_name, frontend_data, expected_cli_data):
        ...
        assert result == expected, f"Transformation failed for {test_name}.\nGot: {result}\nExpected: {expected}"
...
class TestGridTransformationBugRegression:
    ...
    def test_bug_frontend_dict_format_is_transformed(self):
        ...
        assert isinstance(result[0][0], str), "Cell should be transformed to string, not remain as dict"
    ...
    def test_bug_mixed_format_grid(self):
        ...
        assert all(isinstance(cell, str) for cell in result[0]), "All cells should be strings after transformation"
...
class TestGridTransformationInvariance:
    ...
    def test_cell_count_preserved(self):
        ...
        assert original_cell_count == result_cell_count, "Cell count should be preserved"
