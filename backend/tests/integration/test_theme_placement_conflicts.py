...
class TestThemePlacementConflictDetection:
    ...
    def test_apply_placement_detects_letter_conflicts(self, app_client):
        ...
        assert 'O' in data['conflicts'][0] and 'A' in data['conflicts'][0], \
    ...
    def test_apply_placement_with_multiple_conflicts(self, app_client):
        ...
        grid = [
            [{"letter": "X", "isBlack": False}, {"letter": "", "isBlack": False}, {"letter": "", "isBlack": False}],
            [{"letter": "Y", "isBlack": False}, {"letter": "", "isBlack": False}, {"letter": "", "isBlack": False}],
            [{"letter": "Z", "isBlack": False}, {"letter": "", "isBlack": False}, {"letter": "", "isBlack": False}],
        ]
...
class TestThemePlacementEdgeCases:
    ...
    def test_apply_placement_preserves_existing_theme_lock(self, app_client):
        ...
        grid = [
            [{"letter": "", "isBlack": False}, {"letter": "", "isBlack": False}, {"letter": "", "isBlack": False}],
            [{"letter": "", "isBlack": False}, {"letter": "A", "isBlack": False, "isThemeLocked": True}, {"letter": "", "isBlack": False}],
            [{"letter": "", "isBlack": False}, {"letter": "", "isBlack": False}, {"letter": "", "isBlack": False}],
        ]
    ...
    def test_apply_placement_with_whitespace_in_letters(self, app_client):
        ...
        grid = [
            [{"letter": " ", "isBlack": False}, {"letter": " A ", "isBlack": False}, {"letter": "", "isBlack": False}],
            [{"letter": "", "isBlack": False}, {"letter": "", "isBlack": False}, {"letter": "", "isBlack": False}],
            [{"letter": "", "isBlack": False}, {"letter": "", "isBlack": False}, {"letter": "", "isBlack": False}],
        ]
