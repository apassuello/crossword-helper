...
class TestPatternEndpoint:
    ...
    def test_pattern_search_valid(self, client):
        ...
        response = client.post(
            "/api/pattern", json={"pattern": "C?T"}, content_type="application/json"
        )
    ...
    def test_pattern_search_invalid_pattern_type(self, client):
        ...
        response = client.post(
            "/api/pattern", json={"pattern": 123}, content_type="application/json"
        )
...
class TestNumberEndpoint:
    ...
    def test_number_grid_valid(self, client):
        ...
        response = client.post(
            "/api/number", json=grid_data, content_type="application/json"
        )
    ...
    def test_number_grid_missing_size(self, client):
        ...
        response = client.post(
            "/api/number", json={"grid": [[]]}, content_type="application/json"
        )
    ...
    def test_number_grid_missing_grid(self, client):
        ...
        response = client.post(
            "/api/number", json={"size": 11}, content_type="application/json"
        )
...
class TestNormalizeEndpoint:
    ...
    def test_normalize_valid(self, client):
        ...
        response = client.post(
            "/api/normalize", json={"text": "résumé"}, content_type="application/json"
        )
    ...
    def test_normalize_no_body(self, client):
        ...
        response = client.post(
            "/api/normalize", data="", content_type="application/json"
        )
    ...
    def test_normalize_missing_text(self, client):
        ...
        response = client.post(
            "/api/normalize", json={}, content_type="application/json"
        )
    ...
    def test_normalize_non_string_text(self, client):
        ...
        response = client.post(
            "/api/normalize", json={"text": 123}, content_type="application/json"
        )
    ...
    def test_normalize_empty_text(self, client):
        ...
        response = client.post(
            "/api/normalize", json={"text": ""}, content_type="application/json"
        )
    ...
    def test_normalize_too_long(self, client):
        ...
        response = client.post(
            "/api/normalize", json={"text": "a" * 101}, content_type="application/json"
        )
    ...
    def test_normalize_accented_characters(self, client):
        ...
        response = client.post(
            "/api/normalize", json={"text": "café"}, content_type="application/json"
        )
...
class TestErrorHandling:
    ...
    def test_invalid_json(self, client):
        ...
        response = client.post(
            "/api/pattern", data="invalid json", content_type="application/json"
        )
